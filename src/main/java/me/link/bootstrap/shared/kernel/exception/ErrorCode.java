...
public enum ErrorCode {
    ...
    /** 客户端错误: 请求触发限流 */
    RATE_LIMITED(429_000_002, "操作过于频繁,请稍后再试"),
    ...
    /** 业务错误: 连续登录失败次数达到上限,账号被临时锁定 */
    USER_LOCKED(500_001_004, "账号已被临时锁定,请稍后再试"),
    /** 业务错误: 登录账号匹配到多个租户,无法自动判定用户所属租户 */
    USER_TENANT_AMBIGUOUS(500_001_005, "账号存在多个租户,请先选择租户"),
    /** 业务错误: 手机验证码错误或已失效 */
    MOBILE_VERIFY_CODE_ERROR(500_001_006, "验证码错误或已失效"),
