...
import me.link.bootstrap.infrastructure.mapper.CommunitySectionMapper;
...
public class CommunitySectionServiceImpl extends ServiceImpl<CommunitySectionMapper, CommunitySectionPO> implements CommunitySectionService {
    ...
    public PageResult<CommunitySectionResponseVO> page(CommunitySectionPageRequest request) {
        ...
        Page<CommunitySectionPO> result = page(page, wrapper);
    ...
    public CommunitySectionResponseVO update(Long id, CommunitySectionUpdateRequest request) {
        ...
        applyMutableFields(section, request.getName(), code, request.getDescription(), request.getCoverUrl(), request.getParentId(), request.getSort(), request.getStatus());
        ApplicationAssert.requireSuccess(updateById(section), ErrorCode.COMMUNITY_SECTION_NOT_FOUND);
        return get(id);
    }
    ...
    public void delete(Long id) {
        CommunitySectionPO section = getRequired(id);
        long children = count(new LambdaQueryWrapper<CommunitySectionPO>()
    ...
    private void validateParent(Long parentId, Long selfId, Long tenantId) {
        ...
        CommunitySectionPO parent = getById(parentId);
